...
const images = {
  ...
  serena: require('../Images/serena.png'),
  peter: require('../Images/peter.png'),
  adidas_overlay: require('../Images/adidas_overlay.png'),
  adidas: require('../Images/adidas_logo.png')
}
